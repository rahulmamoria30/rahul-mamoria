...
const PROJECT_DATA = [
    {
        ...
        project_detail:
          `Developed a unit test generator for Java and Python using LLM (Language Model) based approach.
           ...
           Implemented the solution as part of an internship Capstone project, demonstrating practical application and
      ...
      },
      {
        ...
        project_detail:
          "This project is an HTML/CSS YouTube clone leveraging the YouTube API. It replicates core functionalities such as video search, playback, and video details (title, uploader, views). Designed with responsive HTML/CSS for a seamless viewing experience across devices.",
  ...
  },
  {
    ...
    project_detail:
      "This project is a music web page designed with HTML, CSS, and JavaScript. It features a responsive layout for optimal viewing across devices and includes a music player with playback controls, dynamic song details display, and playlist management capabilities. The project demonstrates proficiency in frontend development and aims to provide a seamless user experience for music enthusiasts.",
  ...
  },
  {
    ...
    project_detail:
      "This portfolio website is built using Next.js, featuring a clean and responsive design to showcase my skills and projects effectively. It leverages Next.js for fast loading times and SEO benefits, includes a project gallery with descriptions and links, and provides a contact form for collaboration opportunities. Designed to highlight my professional profile and demonstrate expertise in frontend development and Next.js.",
