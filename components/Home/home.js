  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (nextChar) {
        ...
        }, 2000); // Pause for 1 second before moving to the next item
      }
    }, 100); // Display a new character every 100 milliseconds
      ...
      <section className={style.home_page}>
        ...
        <div className={style.home_page_left}>
          ...
          <div>
            ...
            <button className={style.btn} onClick={goToHome}>More About Me</button>

            <div >
              <p className={style.get_in_touch}>Get in touch with</p>
              <div className={style.social_links}>
              <Link className={style.link} href="https://www.instagram.com/rahul_rm__/" passHref target="_blank">
                    <FontAwesomeIcon icon={faInstagram} />
                </Link>
                <Link className={style.link} href="https://www.linkedin.com/in/rahulmm07/" passHref target="_blank">
                    <FontAwesomeIcon icon={faLinkedin} />
                </Link>
                <Link className={style.link} href="https://www.facebook.com/rahul.mamoria.7?mibextid=ZbWKwL" passHref target="_blank">
                    <FontAwesomeIcon icon={faFacebook} />
                </Link>
                <Link className={style.link} href="https://twitter.com/rahul_rm__?t=ciF-p-3-9-76LLWu02gwwg&s=09" passHref target="_blank">
